...
file and nothing else changes. Every reviewer also lists
`writing-for-agents:writing-for-agents` under `skills`, and a test
requires it. Plugin agents ignore `hooks`,
