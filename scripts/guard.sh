...
# Reads the PreToolUse JSON on stdin. If it does not mention the tracker or a
# quest file, exit 0 at once. Otherwise hand it to guard.py under uv. The word
# match is what catches an aliased path such as docs//quests/ID/quest.md; the
